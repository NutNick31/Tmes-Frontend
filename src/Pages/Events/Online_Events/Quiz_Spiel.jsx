...
const Quiz_spiel = () => {
  ...
  return <div className="quiz_container">
    ...
    <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSeCikVIkNuzlsgtjHM6iR1Ry27cBNtNXJ_s8cu6RDeKC1SmiA/viewform?embedded=true" width={640} height={1200} frameborder={0} marginheight={0} marginwidth={0} title="quiz"></iframe>
  </div>
