  ...
  return (
    //<div className="">   </div>
     ...
     <div className="quiz_container">
       <h1>Mineshot</h1>
      <p>Mineshot is one of the online events organized in GREAT STEP. Mineshot is a photography competition.</p>
      <p>It is an online event that witnesses enormous participation from across the country, 
including mining as well as non-mining students/colleges. This photography competition 
requires the participants to upload a photograph related to Mine. The winner is decided 
by judging the photograph's significance and the number of Likes the student gets on 
Facebook. This event was introduced and hence carried on since GREAT STEP 2014.</p>
